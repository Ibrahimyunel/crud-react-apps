        ...
        <>
            <nav id="container_nav">
                <div className="menu-large-max">
                    <Link className="logo" to="/">CRUD</Link>
                    <svg className="open-icon d-lg-none" viewBox="0 0 48 32" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleMenu} ref={openRef}>
                        <path d="M24 32H0V26.6667H24V32ZM48 18.6667H0V13.3333H48V18.6667ZM48 5.33333H24V0H48V5.33333Z" fill="rgb(0, 202, 135)" />
                    </svg>
                    <svg className="close-icon d-lg-none" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleMenu} ref={closeRef}>
